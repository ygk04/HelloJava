...
public class MathExample {
    public static void main(String[] args) {
        ...
        System.out.println("2와 1의 합은" + Calculator.add(2,1)+"입니다");
        System.out.println("2와 1의 차은" +Calculator.subtract(2,1)+ "입니다");
        System.out.println("2와 1의 곱은" +Calculator.multiply(2,1)+ "입니다");
        ...
        double d = 16.0;
        double squarRoot = Math.sqrt(d);
        System.out.println("16.0의 제곱근: " +squarRoot);
