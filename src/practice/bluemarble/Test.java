...
public class Test {
    public static void main(String[] args) {
        ...
        while(playerList.size() != 1) {
            int payIndex = random.nextInt(playerList.size());
            int receiverIndex = random.nextInt(playerList.size());
            ...
            if(payIndex == receiverIndex) {
                ...
                System.out.println("주는 " + pay.getPlayerName() + "님의 보유 금액 : " + pay.getCash());
                System.out.println("받는 " + receiver.getPlayerName() + "님의 보유 금액 : " + receiver.getCash());
                System.out.println("----------------------------------------------");

                System.out.println(pay.getPlayerName() + "님이 " + receiver.getPlayerName() + "에게 1500원을 줍니다.");

                try {
                    pay.payAmountTo(receiver, 1_500);
